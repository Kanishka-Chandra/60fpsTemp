  ...
  return (
    <section className="bg-black">
      <div className="py-12 md:py-20">
        {/* Section header */}
        <div className="max-w-9xl mx-auto text-center pb-12 md:pb-16">
          <h2 className="font-bold text-6xl text-gray-100 font-poppins">Trusting by leading brands, including:</h2>
        </div>
