    ...
    <section>
      <div className="max-w-9xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          {/* Section header */}
          <div className="max-w-9xl mx-auto text-center pb-8">
            <h2 className="font-bold text-8xl font-poppins">Find a plan that fits your business best</h2>
          </div>

          {/* Pricing tables */}
          <div>
            {/* Pricing toggle */}
            <div className="flex justify-center max-w-[11rem] mx-auto mb-8 lg:mb-14 ">
              <div className="relative flex w-full py-1  bg-white rounded-full">
                <span className="absolute inset-0 m-1 pointer-events-none" aria-hidden="true">
                  <span
                    className={`absolute inset-0 w-3/5 bg-black rounded-full shadow-sm transform transition duration-150 ease-in-out ${annual ? 'translate-x-full' : 'translate-x-0'
                      }`}
                  />
                </span>
                <button
                  className={`relative flex-1 text-lg px-3 font-poppins font-bold h-12  ml-1 transition duration-150 ease-in-out ${annual ? 'text-black' : 'text-white'
                    }`}
                ...
                <button
                  className={`relative flex-1 text-lg px-3 font-poppins font-bold h-12 ml-2 transition duration-150 ease-in-out ${annual ? 'text-white' : 'text-black'
                    }`}
            ...
            <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-3 lg:gap-6 items-start lg:max-w-none pt-4">
              {/* Pricing table 1 */}
              <div className="relative flex flex-col h-full p-6 rounded" data-aos="fade-up" data-aos-delay="100">
                <div className="mb-6">
                  <div className="font-poppins text-xl font-bold mb-1">Basic</div>
                  <div className="font-poppins text-gray-900 font-bold inline-flex items-baseline mb-2">
                ...
                <div className="font-poppins font-bold mb-4">Features include:</div>
              ...
              {/* Pricing table 2 */}
              <div className="relative flex flex-col h-full p-6 rounded bg-black text-white" data-aos="fade-up">
                <div className="mb-6">
                  <div className="font-poppins text-xl font-bold mb-1">Pro</div>
                  <div className="font-poppins text-white font-bold inline-flex items-baseline mb-2">
                    <span className="text-3xl">$</span>
                    <span className="text-5xl">{annual ? '749' : '799'}</span>
                    <span>/mo</span>
                  </div>
                  <div className="text-white mb-6">Start building your team and hire the most talented workers in the world.</div>
                  <Link className="btn w-full inline-flex items-center text-black bg-white hover:bg-gray-100 group" href="/schedule-call">
                    Schedule A Call
                ...
                <div className="font-poppins font-bold mb-4">Everything in Basic, plus:</div>
              ...
              {/* Pricing table 3 */}
              <div className="relative flex flex-col h-full p-6 rounded bg-gray-100" data-aos="fade-up" data-aos-delay="100">
                <div className="mb-6">
                  <div className="font-poppins text-xl font-bold mb-1">Enterprise</div>
                  <div className="font-poppins text-gray-900 font-bold inline-flex items-baseline mb-2">
                ...
                <div className="font-poppins font-bold mb-4">Everything in Pro, plus:</div>
                <ul className="text-gray-500 space-y-3 grow">
                  <li className="flex items-center">
                    <svg className="w-3 h-3 fill-current text-emerald-500 mr-3 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                      <path d="M10.28 2.28L3.989 8.575 1.695 6.28A1 1 0 00.28 7.695l3 3a1 1 0 001.414 0l7-7A1 1 0 0010.28 2.28z" />
