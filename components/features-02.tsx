...
export default function Features02() {
  ...
  return (
    <section className="min-h-screen px-8">
      <div className=" sm:px-6 font-poppins ">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="max-w-none  mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 ">Everything you need to find, hire, and manage talents</h2>
          </div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              <div className="md:w-7/12 lg:w-1/2 order-1 md:order-none" data-aos="fade-up">
                ...
                <div className={`${category !== '1' && 'hidden'}`}>
                  <h3 className="h3  mb-3">The member-owned tech society.</h3>
                  ...
                  <ul className="inline-flex flex-col space-y-6">
                    <li className="flex items-start">
                      ...
                      <div>
                        <div className="  font-bold text-lg mb-1">Ensure Quick Turnarounds</div>
                ...
                <div className={`${category !== '2' && 'hidden'}`}>
                  <h3 className="h3   mb-3">Find talents, hire and manage them.</h3>
                  <p className="text-lg text-gray-500 mb-8">
                    Work is is changing faster than at any other time in history. This rapid change requires a new hiring model. A model that is fair,
                    inclusive, and empowering. That's why we built this.
                  </p>
                ...
                <div className={`${category !== '3' && 'hidden'}`}>
                  <h3 className="h3   mb-3">A model that is fair, inclusive, and empowering.</h3>
                  <p className="text-lg text-gray-500 mb-8">
                    Work is is changing faster than at any other time in history. This rapid change requires a new hiring model. A model that is fair,
                    inclusive, and empowering. That's why we built this.
                  </p>
                ...
                <div className={`${category !== '4' && 'hidden'}`}>
                  <h3 className="h3   mb-3">This rapid change requires a new hiring model.</h3>
                  <p className="text-lg text-gray-500 mb-8">
                    Work is is changing faster than at any other time in history. This rapid change requires a new hiring model. A model that is fair,
                    inclusive, and empowering. That's why we built this.
                  </p>
