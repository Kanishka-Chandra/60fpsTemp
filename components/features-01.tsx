    ...
    <section className="relative">
      ...
      <div className="max-w-9xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="max-w-3xl md:pl-4 pb-12 md:pb-16">
            <h2 className="h2 font-poppins text-white">We bring you high-quality talents from 72+ countries</h2>
          </div>

          {/* Carousel */}
          <div className="pb-12 md:pb-16 md:pl-8">
            ...
            <div className="flex mt-12 space-x-3 justify-end">
              <button className="carousel-prev relative z-20 w-11 h-11 rounded-full flex items-center justify-center group bg-gray-700">
                <span className="sr-only">Previous</span>
                <svg
                  className="fill-gray-400 group-hover:fill-white transition duration-150 ease-in-out"
                  width="13"
                  height="12"
                  viewBox="0 0 13 12"
              ...
              <button className="carousel-next relative z-20 w-11 h-11 rounded-full flex items-center justify-center group bg-gray-700">
          ...
          {/* Grid */}
          <div className="max-w-sm mx-auto grid sm:grid-cols-2 sm:max-w-3xl  lg:max-w-none items-start">
            {/* #1 */}
            <div
            ...
            >
              ...
              <h3 className="font-poppins font-bold text-3xl text-white">Reward Performers</h3>
              <div className="text-white text-opacity-80 text-2xl">No more endless task or wasted budget. With us, you and your team are taken care of.</div>
            </div>
