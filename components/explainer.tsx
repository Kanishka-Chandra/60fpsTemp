...
export default function Explainer() {
  ...
  return (
    <section>
      <div className="max-w-9xl mx-auto px-4 sm:px-6 font-poppins">
        <div className="py-12 md:py-20">
          {/* Section header */}
          <div className="max-w-6xl mx-auto text-center pb-12 md:pb-16 -mb-20">
            <h2 className="font-bold text-6xl ">We support early stage startups and leading tech giants.</h2>
          </div>
          ...
          {/* Steps */}
          <div className="relative pb-12 -mt-20">
            {/* Line */}
