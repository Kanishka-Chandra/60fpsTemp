        ...
        <div className="py-12 md:py-20">
          <div className="relative">
            ...
            <div className="max-w-8xl mx-auto text-center pb-12 md:pb-16" data-aos="fade-up">
              <h2 className="h2 font-poppins text-gray-100 ">Scale your business with ready-to-buy services</h2>
            </div>

            {/* Grid */}
            <div className="max-w-2xl mx-auto grid gap-4 sm:gap-6 grid-cols-2 sm:grid-cols-3 lg:grid-cols-2 lg:max-w-none items-start">

              {/* <div className="h-full flex flex-col  transition duration-700 ease-out ">
               
                <div className="mb-4 ">
                  <a className="block group overflow-hidden " href="#0">
                    <Image
                      className="w-full aspect-[101/64] object-cover group-hover:scale-110 transition duration-700 ease-out "
                      src={Service01}
                      width="202"
                      height="128"
                      alt="Item 01"
              ...
              {/* <div className="h-full flex flex-col hover:scale-95 transition duration-700 ease-out rounded-lg">
               
                <div className="mb-4 ">
                  <a className="block group overflow-hidden " href="#0">
                    <Image
                      className="w-full aspect-[101/64] object-cover group-hover:scale-110 transition duration-700 ease-out rounded-xl"
                      src={Service03}
                      width="202"
                      height="128"
                      alt="Item 01"
            ...
            <div className="h-full flex flex-col  items-center overflow-hidden transition duration-700 ease-out px-12  " data-aos="fade-up">
              {/* Image */}
              <div className="mb-4 ">
                <a className="block group overflow-hidden " href="#0">
                  <Image
              ...
              <div className="grow text-left">
                <a className="font-Poppins font-bold text-gray-100 hover:text-blue-500 transition duration-150 ease-in-out" href="#0">
                  System Design
                </a>
              </div>
            </div>
