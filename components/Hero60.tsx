...
export default function Hero60() {
    const onPlayerReady = (event: YouTubeEvent) => { // Explicitly type the parameter
        event.target.mute();
        ...
        <section className="relative overflow-hidden min-h-screen">
            ...
            <div className="absolute top-0 left-0 w-full h-full object-cover -z-10" data-aos-delay="400">
                <iframe
                    ...
                    width="110%"
                    height="130%"
                    src="https://www.youtube-nocookie.com/embed/oWeFw5ZZpcg?modestbranding=1&showinfo=0&rel=0&autoplay=1&loop=1&controls=0&mute=1&iv_load_policy=3&fs=0&disablekb=1"
            ...
            <div className="mx-auto px-4 sm:px-6">
                <div className="pt-28 pb-16 md:pt-0 md:pb-16 md:pt-0 md:pb-20">
                    ...
                    <div className="md:flex ">
                        <div className="ml-auto md:w-3/5" data-aos="fade-up" data-aos-delay="100">
                            <h1 className="text-12xl md:text-xxxl font-extrabold font-cabinet-grotesk text-black lg:mb-80">

                                <a className="md:-ml-8">*</a>
                            </h1>

                            <div className=" text-lg md:text-3xl text-black font-bold font-poppins md:mb-8 md:ml-12 md:text-right md:absolute md:bottom-0 md:left-0">
                                Absolutist certain
